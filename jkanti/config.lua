...
Config.discord_webhook = "" -- to disable put ""

Config.License = "bypassed ma dude"
Config.kickBlacklistedWeapons = false -- set to false is better and it will be removed
Config.EnableNoClipCheck = false -- I think safety Imao
Config.EnablePlayerblipsCheck = false -- safe
Config.basicSecurity = true -- It makes that the player cant have unlimited ammo and can be damaged
Config.resourceDetection = true
Config.cheatEngineDetection = true -- Safe
Config.removeExplosionDamage = true -- Safe
Config.AntiResourceRestart = false -- IF THAT IS FALSE, NO SECURITY
Config.enableStrictGodmodeCheck = true -- Detecting also teleports
Config.enableGodmodeCheck = true
Config.enableSuperjumpCheck = false -- Buggy set better to false


-- only discord and steam ids
Config.bypassIdentifiers = {"discord:722777389179863051", "discord:1111111111111"}

Config.adminIdentifiers = {"discord:708810070757998703", "discord:1111111111111"}

Config.blacklistedPeds = {"s_m_y_swat_01","u_m_y_juggernaut_01","CSB_BallasOG","MP_S_ARMOURED_01","S_F_Y_Cop_01","S_F_Y_Cop_02","S_F_Y_Cop_03","S_M_Y_Cop_01","S_M_Y_Cop_02","S_M_Y_Cop_03","S_F_Y_Sheriff_01","S_F_Y_Sheriff_02","S_F_Y_Sheriff_03","S_M_Y_Marine_01","S_M_Y_Marine_02","S_M_Y_Marine_03","S_M_SECURITY_01","S_M_SECURITY_02","s_m_y_swat_01","a_m_y_mexthug_01","a_c_husky","a_c_cat_01","a_c_boar","a_c_sharkhammer","a_c_coyote","a_c_chimp","a_c_chop","a_c_cow","a_c_deer","a_c_dolphin","a_c_fish","a_c_hen","a_c_humpback","a_c_killerwhale","a_c_mtlion","a_c_pig","a_c_pug","a_c_rabbit_01","a_c_retriever","a_c_rhesus","a_c_rottweiler","a_c_sharktiger","a_c_shepherd","a_c_westy","a_c_cat_01","S_M_SECURITY_03","S_M_Y_ARMYMECH_01","S_M_Y_ARMYMECH_02","S_M_Y_ARMYMECH_03","S_M_Y_BLACKOPS_01","S_M_Y_BLACKOPS_02","S_M_Y_BLACKOPS_03","a_m_o_acult_01"}
...
Config.blacklistedEvents = {
	...
	"gcPhone:_internalAddMessageAGAC",
	"gcPhone:tchat_channelAGAC",
	"esx_vehicleshop:setVehicleOwnedAGAC",
	"esx-qalle-hunting:reward",
	"paycheck:salary",
	"esx_vehicleshop:setVehicleOwned",
	"esx_mafiajob:confiscateAGACPlayerItem",
	"_chat:messageEntAGACered",
	"lscustoms:pAGACayGarage",
	"vrp_slotmachAGACine:server:2",
	"Banca:dAGACeposit",
	"redst0nia:checking",
	"bank:depAGACositt",
	"esx_jobs:caAGACution", "give_back",
	"esx_fueldAGACelivery:pay",
	"esx_carthAGACief:pay",
	"esx_godiAGACrtyjob:pay",
	"esx_pizza:pAGACay",
	"esx_ranger:pAGACay",
	"esx_garbageAGACjob:pay",
	"esx_truckAGACerjob:pay",
	"AdminMeAGACnu:giveBank",
	"AdminMAGACenu:giveCash",
	"esx_goAGACpostaljob:pay",
	"esx_baAGACnksecurity:pay",
	"esx_sloAGACtmachine:sv:2",
	"esx:giAGACveInventoryItem",
	"NB:recAGACruterplayer",
	"esx_biAGAClling:sendBill",
	"esx_jailer:sendToJail",
	"esx_jaAGACil:sendToJail",
	"js:jaAGACiluser",
	"esx-qalle-jail:jailyer",
	"esx_dmvschool:pAGACay", 
	"LegacyFuel:PayFuAGACel",
	"OG_cuffs:cuffCheckNeAGACarest",
	"cuffSeAGACrver",
	"cuffGAGACranted",
	"police:cuffGAGACranted",
	"esx_handcuffs:cufAGACfing",
	"bank:withdAGACraw",
	"dmv:succeAGACss",
	"esx_skin:responseSaAGACveSkin",
	"esx_dmvschool:addLiceAGACnse",
	"esx_mechanicjob:starAGACtCraft",
	"esx_drugs:startHarvestWAGACeed",
	"esx_drugs:startTransfoAGACrmWeed",
	"esx_drugs:startSellWeAGACed",
	"esx_drugs:startHarvestAGACCoke",
	"esx_drugs:startTransAGACformCoke",
	"esx_drugs:startSellCAGACoke",
	"esx_drugs:startHarAGACvestMeth",
	"esx_drugs:startTAGACransformMeth",
	"esx_drugs:startSellMAGACeth",
	"esx_drugs:startHAGACarvestOpium",
	"esx_drugs:startSellAGACOpium",
	"esx_drugs:starAGACtTransformOpium",
	"esx_blanchisAGACseur:startWhitening",
	"esx_drugs:stopHarvAGACestCoke",
	"esx_drugs:stopTranAGACsformCoke",
	"esx_drugs:stopSellAGACCoke",
	"esx_drugs:stopHarvesAGACtMeth",
	"esx_drugs:stopTranAGACsformMeth",
	"esx_drugs:stopSellMAGACeth",
	"esx_drugs:stopHarAGACvestWeed",
	"esx_drugs:stopTAGACransformWeed",
	"esx_drugs:stopSellWAGACeed",
	"esx_drugs:stopHarvestAGACOpium",
	"esx_drugs:stopTransAGACformOpium",
	"esx_drugs:stopSellOpiuAGACm",
	...
	"esx_moneywash:depoAGACsit",
	"esx_moneywash:witAGAChdraw",
	"mission:completAGACed",
	"truckerJob:succeAGACss",
	"99kr-burglary:addMAGAConey",
	"esx_jailer:unjailTiAGACme",
	"esx_ambulancejob:reAGACvive",
	"DiscordBot:plaAGACyerDied",
	"hentailover:xdlol",
	"antiAgAc8:anticheat",
	"antiAgAcr6:detection",
	"esx:getShAGACaredObjAGACect",
	"esx_society:getOnlAGACinePlayers",
	...
	"esx_drugs:pickedUpCAGACannabis",
	"esx_drugs:processCAGACannabis",
	"esx-qalle-hunting:AGACreward",
	"esx-qalle-hunting:seAGACll",
	"esx_mecanojob:onNPCJobCAGACompleted",
	"BsCuff:Cuff696AGAC999",
	"veh_SR:CheckMonAGACeyForVeh",
	"esx_carthief:alertcoAGACps",
...
Config.BlacklistedObjects = {	"hei_prop_carrier_radar_1_l1",
	"v_res_mexball",
	"prop_rock_1_a",
	"prop_rock_1_b",
	"prop_rock_1_c",
